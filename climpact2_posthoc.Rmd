...
plot_index = df_plot %>%
  ...
  geom_text(data = df_plot_stats, x = 1951, y = max(df_plot$value, na.rm = T)*1.05, col = "black", fill = "black", hjust = "left",
            aes(label = paste0("Median slope = ", Slope*10, " / decade\np-value = ", P_Value))) +
  geom_text(data = df_plot_stats, x = 2100, y = min(df_plot$value, na.rm = T)*0.9, col = "darkgrey", fill = "darkgrey", hjust = "right",
